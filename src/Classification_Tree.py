...
def gaussianNB(test_data, column, value):
    '''
        ...
        ví dụ: cần tính xác xuất temperature = 66
            ...
            value = 66
    '''
    mean = {0: [50, 20], 1: [100, 20], 2: [30, 100], 3: [85, 70], 4: [76, 52], 5: [36, 28], 6: [50, 80], 7: [78, 25],
            8: [69, 87], 9: [36, 45], 10: [69, 70], 11: [90, 40]}
    standard_deviation = {0: [78, 63], 1: [72, 36], 2: [23, 45], 3: [78, 63], 4: [72, 36], 5: [48, 79], 6: [45, 96],
                          7: [74, 69], 8: [48, 57], 9: [93, 67], 10: [67, 48], 11: [85, 70]}
